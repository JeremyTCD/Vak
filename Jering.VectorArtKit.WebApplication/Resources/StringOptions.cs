namespace Jering.VectorArtKit.WebApplication.Resources
{
    public class StringOptions
    {
        ...
        public string ViewTitle_TestTwoFactor { get; set; } = "Test two factor authentication";
        public string ViewTitle_SendEmailVerificationEmailConfirmation { get; set; } = "Send email verification email confirmation";
        public string ViewTitle_EmailVerificationConfirmation { get; set; } = "Email verification confirmation";
        public string ViewTitle_AlternativeEmailVerificationConfirmation { get; set; } = "Alternative email verification confirmation";
        #endregion

        #region Email
        public string Email_EmailVerification_Subject { get; set; } = "Confirm email";
        ...
        public string ErrorMessage_DisplayName_InUse { get; set; } = "Display name already in use by another account.";
        public string ErrorMessage_TwoFactorCode_Invalid { get; set; } = "Invalid code.";
        public string Email_EmailVerification_Message { get; set; } = "Please confirm your email by clicking this link: <a href=\"{0}\">link</a>";
        ...
        public string ErrorMessage_DisplayName_FormatInvalid { get; set; } = "Display name must have at least 2 characters.";
        public string ErrorMessage_NewDisplayName_MustDiffer { get; set; } = "New display name cannot be the same as current display name.";
        #endregion
