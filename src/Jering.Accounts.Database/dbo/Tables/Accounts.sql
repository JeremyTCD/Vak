CREATE TABLE [dbo].[Accounts] (
	...
	[SecurityStamp]             UNIQUEIDENTIFIER CONSTRAINT [DF_dbo_Accounts_SecurityStamp] NOT NULL,
    [PasswordHash]		        NVARCHAR (84) NOT NULL,
	[PasswordLastChanged]		DATETIMEOFFSET(0) CONSTRAINT [DF_dbo_Accounts_PasswordLastChanged] NOT NULL,
