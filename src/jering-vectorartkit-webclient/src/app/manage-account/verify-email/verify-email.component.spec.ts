...
//let resetPasswordComponentFixture: ComponentFixture<VerifyEmailComponent>;
//let resetPasswordComponent: VerifyEmailComponent;
//let resetPasswordDebugElement: DebugElement;
//let testVerifyEmailResponseModel: TwoFactorLogInResponseModel;
...
//            declarations: [VerifyEmailComponent, StubDynamicFormComponent],
//            providers: [{ provide: ActivatedRoute, useClass: StubActivatedRoute }]
//        }).compileComponents();
//    }));

//    beforeEach(() => {
//        resetPasswordComponentFixture = TestBed.createComponent(VerifyEmailComponent);
