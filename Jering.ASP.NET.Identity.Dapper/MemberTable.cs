...
namespace Jering.ASP.NET.Identity.Dapper
{
        ...
        where TMember : Member
    {
        ...
        /// <summary>
        /// Returns the username for a given member ID
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public Task<string> GetMemberUsernameAsync(int id)
        {
            return _sqlConnection.ExecuteScalarAsync<string>("[Website].[GetMemberUsername]", new { Id = id }, commandType: CommandType.StoredProcedure);
        }
        ...
        /// <summary>
        /// Returns the TMember for a given member ID
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public async Task<TMember> GetMemberAsync(int id)
        {
            // is there a dapper function that allows only the first value to be retrieved?
            return (await _sqlConnection.QueryAsync<TMember>("[Website].[GetMember]", new { Id = id }, commandType: CommandType.StoredProcedure)).FirstOrDefault();
        }

        /// <summary>
        /// Returns the TMember for a given username
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public async Task<TMember> GetMemberByUsernameAsync(string username)
        {
            return (await _sqlConnection.QueryAsync<TMember>("[Website].[GetMemberByUsername]", new { Username = username }, commandType: CommandType.StoredProcedure)).FirstOrDefault();
        }
        ...
        public async Task InsertMemberAsync(TMember member)
        {
            member.Id = await _sqlConnection.ExecuteScalarAsync<int>(@"[Website].[InsertMember]", member, commandType: CommandType.StoredProcedure);
        }
        ...
        {
            return _sqlConnection.ExecuteAsync("[Website].[DeleteMember]", new { Id = id }, commandType: CommandType.StoredProcedure);
        }
        ...
        /// </summary>
        /// <param name="Member"></param>
        public Task DeleteMemberAsync(TMember Member)
        {
            return DeleteMemberAsync(Member.Id);
        }
        ...
        /// <param name="Member"></param>
        /// <returns></returns>
        public Task UpdateMemberAsync(TMember member)
        {
            return _sqlConnection.ExecuteAsync(@"[Website].[UpdateMember]", member, commandType: CommandType.StoredProcedure);
        }
    }
}
